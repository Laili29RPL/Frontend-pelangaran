...
export default function Pelanggaran() {
    ...
    {/**tempat menyimpan data yg ditambahkan*/}
    ...
    let simpanData = event => {
        ...
        if (action === "insert"){
            let endpoint = `http://localhost:8080/pelanggaran`
            let request = {nama_pelanggaran: namaPelanggaran,
                           poin : poin}
        /**sending data */
                     ...
                     <div className="modal" id="modalPelanggaran">
                         <div className="modal-dialog modal-md">
                             <div className="modal-content">
                                <div className="modal-header" style={{background: `orange`}}>
